namespace MonoTinker.Code.Components.UI
{
    ...
    public class StatusBar : InterfaceElement
    {
        ...
        private void Init()
        {
            ...
            Sprite hud = AssetManager.Instance.Get<Sprite>(Sn.Menu.Hud).DirectClone();
            hud.Position = Vector2.Zero;
            Sprite healthbar = AssetManager.Instance.Get<Sprite>(Sn.Menu.HealthBar).DirectClone();
            healthbar.Position = new Vector2(83,6);
            Sprite manaBar = AssetManager.Instance.Get<Sprite>(Sn.Menu.ManaBar).DirectClone();
            manaBar.Position = new Vector2(83, 26);
            Sprite spiritBar = AssetManager.Instance.Get<Sprite>(Sn.Menu.SpiritBar).DirectClone();
